...
| Quoted strings | 🚧 | 2/7 | Quoted node names / prop keys / type annotations fail |
...
| Properties (`key=value`) | ✅ | 11/11 | `arg_and_prop_same_name.kdl`, property ordering, duplicate keys |
| Children blocks | 🚧 | 8/10 | Optional semicolon after children not handled |
| Multiple nodes | ✅ | 5/5 | Semicolons, newlines, `crlf_between_nodes.kdl` |
| Type annotations | 🚧 | 6/38 | Quoted / raw-string type annotations fail |
| Line comments (`//`) | 🚧 | 7/12 | After-type comments, slashdash+comment interaction |
...
| Multi-line strings (`"""`) | 🚧 | 15/20 | Not yet implemented (many false passes) |
| Raw strings (`#"..."#`) | 🚧 | 5/10 | Not yet implemented (many false passes) |
| Unicode whitespace | ✅ | 2/2 | `emoji.kdl`, `bare_emoji.kdl` |
| Identifier validation | 🚧 | 87/95 | 8 false-negatives (parser too permissive on `+0n`, `0n`, etc.) |
...
| **Total** | — | **253 / 338** | 85 failures: 32 unimplemented features, 53 type annotation gaps |
